  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterDemoArtifactApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="t$('jhipsterDemoArtifactApp.employee.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.employee.firstName')" for="employee-firstName"></label>
            <input
              type="text"
              class="form-control"
              name="firstName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.employee.lastName')" for="employee-lastName"></label>
            <input
              type="text"
              class="form-control"
              name="lastName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.employee.email')" for="employee-email"></label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterDemoArtifactApp.employee.phoneNumber')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.employee.hireDate')" for="employee-hireDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.employee.salary')" for="employee-salary"></label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterDemoArtifactApp.employee.commissionPct')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.employee.manager')" for="employee-manager"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.employee.department')" for="employee-department"></label>
