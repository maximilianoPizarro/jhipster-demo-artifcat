      ...
      if (this.jobHistory.id) {
        this.jobHistoryService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('jhipsterDemoArtifactApp.jobHistory.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.jobHistoryService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('jhipsterDemoArtifactApp.jobHistory.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
