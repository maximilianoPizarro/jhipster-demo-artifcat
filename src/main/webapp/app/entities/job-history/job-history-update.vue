  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterDemoArtifactApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="t$('jhipsterDemoArtifactApp.jobHistory.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterDemoArtifactApp.jobHistory.startDate')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.jobHistory.endDate')" for="job-history-endDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.jobHistory.language')" for="job-history-language"></label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                :key="language"
                :value="language"
                :label="t$('jhipsterDemoArtifactApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.jobHistory.job')" for="job-history-job"></label>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterDemoArtifactApp.jobHistory.department')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.jobHistory.employee')" for="job-history-employee"></label>
