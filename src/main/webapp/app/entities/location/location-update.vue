  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterDemoArtifactApp.location.home.createOrEditLabel"
          data-cy="LocationCreateUpdateHeading"
          v-text="t$('jhipsterDemoArtifactApp.location.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterDemoArtifactApp.location.streetAddress')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.location.city')" for="location-city"></label>
            <input
              type="text"
              class="form-control"
              name="city"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterDemoArtifactApp.location.stateProvince')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterDemoArtifactApp.location.country')" for="location-country"></label>
